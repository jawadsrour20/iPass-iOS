...
class MyPasswordsPageTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        items += [item1,item2,item3,item4,item5,item6,item7,item8,item9,item10,item2,item2,item2,item2,item2,item2,item2,item2,item2,item2,item2,item2,item2]
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.AppNameInCell.text = item.AppName
        cell.EmailInCell.text = item.Mail
        cell.MyImageInCell.image = item.ImageView
        // Configure the cell...
